...
public class LoginServiceImpl implements ILoginService {
    ...
    public boolean login() {
        ...
        while (!isLogin) {
            ...
            params.add(new BasicNameValuePair(LoginParaEnum.UL.para(), String.valueOf(millis)));
    ...
    public String getUuid() {
        ...
        params.add(new BasicNameValuePair(UUIDParaEnum.UNIX.para(), String.valueOf(System.currentTimeMillis())));
